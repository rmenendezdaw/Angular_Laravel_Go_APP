...
func ProfileRetrieve(c *gin.Context) {
	...
	userModel, err := controllers.FindOneUser(&UserModel{Username: username})
	if err != nil {
...
func UsersRegistration(c *gin.Context) {
	...
	if err := controllers.SaveOne(&userModelValidator.userModel); err != nil {
		c.JSON(http.StatusUnprocessableEntity, common.NewError("database", err))
		return
	}
...
func UsersLogin(c *gin.Context) {
	...
	userModel, err := controllers.FindOneUser(&UserModel{Email: loginValidator.userModel.Email})
	...
	models.UpdateContextUserModel(c, userModel.ID)
	serializer := UserSerializer{c}
